...
const SUBGRAPH_URLS: Record<string, { decentralized: string }> = {
  ...
  "1": {
    decentralized:
      "https://gateway.thegraph.com/api/[api-key]/subgraphs/id/3fy93eAT56UJsRCEht8iFhfi6wjHWXtZ9dnnbQmvFopF",
  },
  // Optimism subgraph, by subgraphs.messari.eth (0x7e8f317a45d67e27e095436d2e0d47171e7c769f)
  "10": {
    decentralized:
      "https://gateway.thegraph.com/api/[api-key]/subgraphs/id/CXDZPduZE6nWuWEkSzWkRoJSSJ6CneSqiDxdnhhURShX",
  },
  // Gnosis subgraph, by subgraphs.messari.eth (0x7e8f317a45d67e27e095436d2e0d47171e7c769f)
  "100": {
    decentralized:
      "https://gateway.thegraph.com/api/[api-key]/subgraphs/id/J8k2z8MhdhABfVZU5HtyRvzCT85bLLF886V4iDpt53Jr",
  },
  // Avalanche C-Chain subgraph, by subgraphs.messari.eth (0x7e8f317a45d67e27e095436d2e0d47171e7c769f)
  "43114": {
    decentralized:
      "https://gateway.thegraph.com/api/[api-key]/subgraphs/id/2Vt8WtdXNZUEeaVtzyEd1dpioJf44nvomzkd4HhubfKS",
  },
  // Aurora subgraph, by subgraphs.messari.eth (0x7e8f317a45d67e27e095436d2e0d47171e7c769f)
  "1313161554": {
    decentralized:
      "https://gateway.thegraph.com/api/[api-key]/subgraphs/id/9zXFpPQHyTmXXygtNPwjBS6d4SMGzv7qMiha4bJ3fbyB",
  },
  // Harmony subgraph, by subgraphs.messari.eth (0x7e8f317a45d67e27e095436d2e0d47171e7c769f)
  "1666600000": {
    decentralized:
      "https://gateway.thegraph.com/api/[api-key]/subgraphs/id/6gnHHn7562tDjCrrnSiMiR1H1NndrannPQ7LcYxMgF9t",
  },
};
...
// Define the LiquidityPool interface reflecting the GraphQL response
...
// Function to transform liquidity pool data into ContractTag objects
function transformLiquidityPoolsToTags(chainId: string, pools: LiquidityPool[]): ContractTag[] {
  const validPools: LiquidityPool[] = [];
  ...
  pools.forEach((pool) => {
    ...
    if (symbolInvalid) {
      rejectedSymbols.push(`Liquidity Pool: ${pool.outputToken.id} rejected due to invalid symbol - Symbol: ${pool.outputToken.symbol}`);
    } else {
  ...
  if (rejectedSymbols.length > 0) {
    console.log("Rejected liquidity pools:", rejectedSymbols);
  }
  ...
  returnTags = async (
    ...
    while (isMore) {
      try {
        ...
        const tags = transformLiquidityPoolsToTags(chainId, pools);
        allTags.push(...tags);
